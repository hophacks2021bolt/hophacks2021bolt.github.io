...
function Survey(){
    ...
    const [hoursBathroomElectronicsPerDay, setHoursBathroomElectronicsPerWeek] = useState(3)
    ...
    return (
        <Carousel id="survey" activeIndex={questionNum}>
            <Carousel.Item>
                <Form.Group className="questionDiv mb-3" controlId="formBasicDropdown">
                    <Form.Label>Please select your country</Form.Label>
